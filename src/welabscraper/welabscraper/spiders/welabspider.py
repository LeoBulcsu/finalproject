...
class RCLensSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        rclens_categories = response.css('div.uk-clearfix > p a::attr(href)')
        
        for category in rclens_categories:

            category_url = category.extract()
    ...
    def parse_brands(self, response):
        ...
        lens_brands = response.css('div.uk-clearfix > p a::attr(href)')
        
        for brand in lens_brands:
            category_url = brand.extract()
